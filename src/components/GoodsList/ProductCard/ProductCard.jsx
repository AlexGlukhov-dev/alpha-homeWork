...
const ProductCard = ({name, description, img, price, id, liked}) => {
    ...
    return (
        <div className={classes['product']}>
            <button onClick={deleteCardHandle} className={classes['product__delete']}>
            ...
            <div className={classes['product__bottom']}>
                <span>{price}</span>
                <button onClick={likeToggle} className={!liked ? cn(classes['like'], classes['like-no-active']) : cn(classes['like'], classes['like-active'])}>
